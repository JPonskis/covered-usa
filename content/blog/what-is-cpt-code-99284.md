---
title: "What Is CPT Code 99284? Decoded for Patients (Not Coders)"
description: "CPT 99284 is a Level 4 emergency room visit code billed for moderate-complexity care. Learn what it means, what it costs, and how to spot overcharges."
date: "2026-05-15"
slug: "what-is-cpt-code-99284"
keywords: ["CPT 99284", "CPT code 99284", "emergency room CPT codes", "medical bill codes", "Level 4 ER visit", "hospital bill overcharges"]
target: "analyzer"
---
...
*Source: [CMS Medicare Physician Fee Schedule](https://www.cms.gov/medicare/physician-fee-schedule), 2026 national averages.*
...
Per the [American College of Emergency Physicians (ACEP)](https://www.acep.org/administration/reimbursement/ed-facility-level-coding-guidelines), a Level 4 ER visit requires moderate complexity medical decision-making. That is determined by three factors:

1. **Number and complexity of problems addressed** - multiple possible diagnoses or a single condition with meaningful risk of complications
2. **Amount and complexity of data reviewed** - typically includes at least one advanced test like an ECG, CT scan, or specialized lab panel
3. **Risk of complications** - treatment options that carry moderate risk, such as prescription drug management or procedures with some complication potential
...
*Sources: [MedFeeSchedule.com 2026 fee schedule](https://www.medfeeschedule.com/code/99284), [PayerPrice 2026 rate data](https://payerprice.com/rates/99284-CPT-fee-schedule).*
...
Up to 80% of medical bills contain at least one error, according to medical billing advocacy groups. The [CMS dispute process](https://www.cms.gov/medical-bill-rights/help/dispute-a-bill) exists precisely because overcharges are common.
...
1. **Request your itemized bill.** Federal law requires hospitals to provide this within 30 days at no charge. Call the billing department and ask specifically for "an itemized statement with CPT codes."
2. **Pull your medical records.** Request the physician's notes, nursing notes, and any diagnostic reports from the visit. These are the supporting documentation for every CPT code assigned.
3. **Compare the documentation to the code.** Does the physician's note describe multiple diagnoses, advanced testing, and moderate-risk decision-making? If not, 99284 is not supported.
4. **Look up the Medicare rate.** The Medicare rate for 99284 in 2026 is roughly $118 to $166. If you were billed $800 for the same code, that gap is worth questioning, especially if you are uninsured.
5. **Submit a formal billing dispute.** Call the hospital billing department, cite the specific code, and explain why you believe the level was miscoded. Ask them to review against the physician's documentation.
6. **File an insurer appeal if needed.** If your insurer paid 99284 without question and you believe it should have been downcoded, you can request a clinical review from the insurer.
7. **Ask about financial assistance.** If the bill stands and is unaffordable, ask specifically about charity care, sliding-scale programs, or interest-free payment plans. Hospitals that receive federal funding are required to have financial assistance programs.
...
Upload your hospital bill to the free [CoveredUSA Bill Analyzer](/medical-bill-analyzer) to find errors, overcharges, and charity care options in 30 seconds. The tool compares your charges against Medicare rates, flags CPT code mismatches, and shows you exactly what a fair rate for each code looks like in 2026.
