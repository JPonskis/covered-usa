...
The table below uses the 2026 Federal Poverty Guidelines published by [HHS ASPE](https://aspe.hhs.gov/topics/poverty-economic-mobility/poverty-guidelines) for the 48 contiguous states and Washington D.C.
...
**Low-income SEP eliminated.** Starting with the 2026 plan year, the SEP that allowed households below 150% FPL to enroll year-round is no longer available through HealthCare.gov. This affects roughly 4 million people who used that pathway. If you are in this income range, check Medicaid eligibility first via [Medicaid.gov](https://www.medicaid.gov) or [CoveredUSA](/screener).

**Enhanced subsidy cliff returned.** The American Rescue Plan's expanded premium tax credits expired at the end of 2025. As of 2026, no subsidies are available above 400% FPL. This affects about 2 million enrollees who were previously receiving assistance at higher incomes, according to [KFF](https://www.kff.org/affordable-care-act/8-things-to-watch-for-the-2026-aca-open-enrollment-period/).
...
- **Medicaid or CHIP:** Year-round enrollment with no deadline. If your income falls below about 138% FPL (in expansion states), you qualify at any time. [Use the CoveredUSA screener to check](/screener).
...
Check your eligibility now at CoveredUSA, it takes 2 minutes. [Start the screener](/screener).
...
Go to [healthcare.gov](https://www.healthcare.gov/coverage-outside-open-enrollment/special-enrollment-period/) if your state uses the federal exchange. If your state runs its own exchange (such as Covered California, Washington Healthplanfinder, or kynect in Kentucky), go directly to that state's website. A licensed insurance agent or certified navigator can also help you apply at no cost.
