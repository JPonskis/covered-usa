---
title: "How Much Should an ER Visit Cost? CPT 99284 and 99285 vs. Your Bill"
description: "Learn what CPT codes 99284 and 99285 mean, what Medicare pays, and how to spot overcharges on your ER bill. Real 2026 numbers."
date: "2026-05-14"
slug: "er-visit-cost-cpt-99284-99285"
keywords: ["ER visit cost", "CPT 99284", "CPT 99285", "emergency room bill", "hospital bill overcharge"]
target: "analyzer"
---
...
This guide explains what CPT codes 99284 and 99285 actually mean, what the government says those visits should cost, and how to compare your bill against real benchmarks. If you have already received a bill that looks wrong, the [CoveredUSA Bill Analyzer](/medical-bill-analyzer) can flag line items that exceed Medicare rates in about 30 seconds.
...
| CPT Code | Level | Complexity | Typical Condition |
|----------|-------|------------|-------------------|
| 99281 | Level 1 | Minimal | Minor cut, splinter removal |
| 99282 | Level 2 | Straightforward | Earache, mild allergic reaction |
| 99283 | Level 3 | Low | Sprained ankle, simple UTI |
| 99284 | Level 4 | Moderate | Chest pain, moderate trauma |
| 99285 | Level 5 | High | Stroke, heart attack, severe trauma |
...
## What Medicare Actually Pays for 99284 and 99285
...
| CPT Code | Median Facility List Price | Medicare Facility Payment | Cash Price (Median) |
|----------|---------------------------|--------------------------|---------------------|
| 99284 | $1,189 | approx. $230 to $350 | approx. $700 |
| 99285 | $1,784 | approx. $350 to $500 | approx. $1,097 |
...
**Medicaid:** If your income is below roughly 138% of the Federal Poverty Level (FPL) in an expansion state, Medicaid may cover emergency services retroactively in some situations. Check your eligibility at [CoveredUSA's screener](/screener).
...
| Scenario | Typical Insured Out-of-Pocket | Typical Uninsured Cash Price |
|----------|-------------------------------|------------------------------|
...
Request an itemized bill, look up the CPT code for each line item, and compare the billed amount to the Medicare rate for your area. Any charge that is significantly above the Medicare rate -- especially for straightforward services like labs, IV placement, or basic imaging -- is worth questioning. Upload your bill to the [CoveredUSA Bill Analyzer](/medical-bill-analyzer) to get a line-by-line comparison against Medicare benchmarks automatically.
