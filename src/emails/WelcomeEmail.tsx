...
export function buildWelcomeHtml(props: WelcomeEmailProps): string {
  ...
  const preheader = `You may qualify for ${primaryProgramName}. Here's how to get covered.`;
              ...
              <tr>
                <td style="padding: 16px 36px 0 36px;">
                  <p style="margin: 0; font-size: 14px; line-height: 22px; color: #8A8278; text-align: center; font-family: Georgia, 'Times New Roman', serif;">
                    Or <a href="${resultsUrl}#get-help" style="color: #0e9f6e; text-decoration: underline;">get help from a free licensed agent</a> — they handle everything for you
                  </p>
                </td>
              </tr>` : '';
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="max-width: 560px; width: 100%; background-color: #ffffff; border-radius: 12px; border: 1px solid #D0E4F7;">
          ...
          <tr>
            <td style="padding: 16px 36px 0 36px;">
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 26px; color: #374151; font-family: Georgia, 'Times New Roman', serif;">
                Based on your screening, you may qualify for <strong style="color: #111928;">${primaryProgramName}</strong> — ${valueText}.
              </p>
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 26px; color: #374151; font-family: Georgia, 'Times New Roman', serif;">
                The next step is to apply. It's free, and most people finish in under 10 minutes.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 36px 0 36px;">
              <p style="margin: 0; font-size: 14px; line-height: 22px; color: #8A8278; text-align: center; font-family: Georgia, 'Times New Roman', serif;">
                <a href="${resultsUrl}" style="color: #6B7280; text-decoration: underline;">View your full results page</a>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 36px 32px 36px;">
              <p style="margin: 0 0 14px 0; font-size: 15px; line-height: 23px; color: #8A8278; font-family: Georgia, 'Times New Roman', serif;">Questions? Just reply to this email.</p>
